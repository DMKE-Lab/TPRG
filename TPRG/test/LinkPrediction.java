...
public class LinkPrediction {
	...
	public LinkPrediction(int iEntities, int iRelations, int iFactors) {
	...
	public void evaluate(String fnTestTriples) throws Exception {
		...
		while ((line = reader.readLine()) != null) {
			if(iCnt % 1000 == 0){
				System.out.println("triple:" + iCnt);
			}
...
//		int Entity_num = 500;
//		int Relation_num = 20;
//		int embedding_size = 400;
//		String datasetsname = "gdeltROAN";
//		String testdatasetname = "gdeltROAN400";

//		int Entity_num = 10585;
//		int Relation_num = 10;
//		int embedding_size = 400;
//		String datasetsname = "yago1";
//		String testdatasetname = "yago1-400";

//		int Entity_num = 14763;
//		int Relation_num = 237;
//		int embedding_size = 512;
//		String datasetsname = "icewsyu";
//		String testdatasetname = "icewsyu-512";

		int Entity_num = 10488;
		int Relation_num = 251;
		int embedding_size = 512;
		String datasetsname = "ROANicews05-15";
		String testdatasetname = "icews05-15-512";

		String fnRealMatrixE = "output\\" + testdatasetname + "\\MatrixE.real.best";
		String fnRealMatrixR = "output\\" + testdatasetname + "\\MatrixR.real.best";
		String fnImagMatrixE = "output\\" + testdatasetname + "\\MatrixE.imag.best";
		String fnImagMatrixR = "output\\" + testdatasetname + "\\MatrixR.imag.best";
		String fnTrainTriples = "datasets\\TemperalTest\\" + datasetsname + "\\train.txt";
		String fnValidTriples = "datasets\\TemperalTest\\" + datasetsname + "\\valid.txt";
		String fnTestTriples = "datasets\\TemperalTest\\" + datasetsname + "\\test.txt";
		LinkPrediction eval = new LinkPrediction(Entity_num, Relation_num, embedding_size);
