...
public class GroundAllRules {
	...
	public static void main(String[] args) throws Exception {
		String datasetname = "icewsyu";
		String fnRelationIDMap = "datasets\\TemperalTest\\"+ datasetname + "\\relation2id.txt";
		String fnRuleType = "datasets\\TemperalTest\\" + datasetname + "\\yago_rule";
		String fnTrainingTriples = "datasets\\TemperalTest\\" + datasetname + "\\train.txt";
		String fnOutput = "datasets\\TemperalTest\\" + datasetname + "\\groundings.txt";
